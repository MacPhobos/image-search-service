...
def upgrade() -> None:
    ...
    op.add_column('face_detection_sessions', sa.Column('faces_assigned_to_persons', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('face_detection_sessions', sa.Column('clusters_created', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('face_detection_sessions', sa.Column('suggestions_created', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('face_detection_sessions', sa.Column('current_batch', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('face_detection_sessions', sa.Column('total_batches', sa.Integer(), nullable=False, server_default='0'))
